<div>
    ...
    <div class="group relative my-2">
        <div
            ...
            <div id="download-image" role="tooltip" class="absolute z-10 invisible inline-block px-3 py-2 text-sm font-medium
        ...
        <img src="{{ $message->getFirstMediaUrl('attachments') }}" class="rounded-lg" />
    </div>
    @else
