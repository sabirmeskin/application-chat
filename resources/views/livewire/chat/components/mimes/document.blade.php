<div class="flex flex-col w-full max-w-[320px] leading-1.5 p-4 border-gray-300 dark:border-gray-100  rounded-e-xl rounded-es-xl ">
    <div class="flex items-start rounded-xl p-2 dark:bg-gray-400">
       <div class="me-2">
       ...
       <div class="inline-flex self-center items-center">
          <flux:button icon="download" variant="ghost" />
       </div>
    </div>
 </div>
