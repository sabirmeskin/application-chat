<div x-data="{
    ...
    loading: true
}" x-init="setTimeout(() => loading = false, 1000)" class="h-full">
    ...
    <div x-show="!loading" class="flex h-full relative ">
        ...
        <div class="flex-1 h-full">
            ...
            <div x-show="sidebarOpen && window.innerWidth < 768" @click="sidebarOpen = false"
                class="fixed inset-0 bg-black opacity-25 z-10 md:hidden" style="pointer-events: auto;"></div>
            ...
            <button
                ...
                :class="{ 'hidden': sidebarOpen }" @click="sidebarOpen = !sidebarOpen">
